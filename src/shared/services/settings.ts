...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'roleplay_ai',
      title: 'Roleplay AI',
      description: 'Configure roleplay LLM, image generation, and TTS providers.',
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tip: 'Roleplay TTS provider. OpenRouter uses the OpenAI-compatible audio speech API.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
      ...
      type: 'password',
      placeholder: 'sk-or-xxx',
      tip: 'API key for the selected TTS provider. For OpenRouter, use your OpenRouter API key.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
      ...
      tip: 'Default TTS model for roleplay voices.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
      ...
      tip: 'Fallback OpenRouter TTS model used when the primary preview model returns a 5xx error.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
    ...
    },
    {
      ...
      tip: 'TTS endpoint. Gemini TTS is requested as PCM and stored as browser-playable WAV automatically.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
    ...
    },
    {
      ...
      tip: 'Admin-editable global voice library. Each character voicePreset should reference one profile id. OpenAI-compatible providers can use instructions to shape emotion and delivery.',
      group: 'roleplay_ai',
      tab: 'ai',
    },
    {
